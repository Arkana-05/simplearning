...
@section('header')
    <div class="page-header">
        ...
        <ul class="breadcrumbs">
            ...
            <li class="separator"><i class="icon-arrow-right"></i></li>
            <li class="nav-item"><a href="{{ url('backend/jadwal-detail/'.$data->id) }}">{{ $data->matkul->nama }}</a></li>
            <li class="separator"><i class="icon-arrow-right"></i></li>
...
@endsection
@section('kelas')
    @if($activePertemuan?->status !== 'Selesai' && $activePertemuan->absen?->status == 'Hadir'|| $activePertemuan?->status == 'Belum Mulai')
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-3">
                            <div class="info-box p-3 rounded shadow-sm"
                                ...
                                <p class="text-muted small mb-1">
                                    <i class="fas fa-info-circle me-1 text-danger"></i> Tidak Hadir
                                </p>
                                        ...
                                        @foreach($data->pertemuan as $p)
                                            ...
                                            <td>
                                                ...
                                                @elseif($absen?->status == 'Tidak Hadir')
                                                    <span class="badge bg-danger" data-bs-toggle="tooltip" data-bs-title="Tidak Hadir"><i class="fas fa-times-circle"></i></span>
                                                @else
