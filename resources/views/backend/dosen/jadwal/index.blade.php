        ...
        <div class="card-body p-4">
            ...
            <div class="ajar-info">
                ...
                <div>
                    ...
                    Pertemuan: <strong>{{ $j->pertemuan->where('status', 'Selesai')->count() }}/{{ $j->pertemuan->count() }}</strong>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center gap-2 mt-3">
                ...
                {{--  @if($j->canAccess)  --}}
                    ...
                    @endphp
                    <a href="{{ url('backend/jadwal-detail/'.$j->id) }}" class="btn {{ $hariJadwal == $hariSekarang ? 'btn-success' : 'btn-outline-danger' }} btn-sm px-3 d-flex align-items-center gap-1">
                        <i class="fas fa-check-circle"></i> Mulai Kelas
                    </a>
