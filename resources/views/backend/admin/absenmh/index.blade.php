@extends('layouts.app')
@section('title')
    <title>Absensi Mahasiswa | Sistem Informasi E-learning</title>
@endsection

@section('header')
    <div class="page-header">
        <h3 class="fw-bold mb-3">Data Absensi Mahasiswa</h3>
      ...
      <div class="card">
        <div class="card-header">
          <div class="d-flex align-items-center">
            <h4 class="card-title">Data Absensi Mahasiswa</h4>
            <a class="btn btn-primary btn-round ms-auto" href="{{ route('backend.absen.create') }}">
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-button-action">
                      <a href="{{ Route('backend.absen.edit', $d->id) }}" type="button" data-bs-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Task"  style="padding: 10px">
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <p>Are you sure for delete data absen {{ $d->mhs->nama }}?</p>
                            </div>
                            <div class="modal-footer">
                              <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                              <form action="{{ Route('backend.absen.destroy', $d->id) }}"
                                  method="post">
                                  @csrf
                                  @method('delete')
                      ...
                      <div class="modal fade" id="detailBackdrop{{ $d->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h1 class="modal-title fs-5" id="staticBackdropLabel">Detail Absensi Mahasiswa </h1>
                              <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
                              <form action="">
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-2 ">
                                      <label><i class="fas fa-user me-2 mb-2"></i><strong> {{ $d->mhs->nama }} </strong></label>
                                      ...
                                      <label><i class="fas fa-calendar-alt me-2"></i><strong>Tanggal Pertemuan : {{ $d->created_at->format('d F Y') }}</strong></label>
                                    </div>
