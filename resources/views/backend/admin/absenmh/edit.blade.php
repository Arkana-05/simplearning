@extends('layouts.app')
@section('title')
    <title>Edit Data Absensi Mahasiswa {{ $data->nama }} | Sistem Informasi E-learning</title>
@endsection
@section('header')
    <div class="page-header">
        ...
        <ul class="breadcrumbs mb-3">
            ...
            <li class="nav-item">
                <a href="{{ url('/backend/absen') }}">Absen</a>
            </li>
            <li class="separator">
                <i class="icon-arrow-right"></i>
            </li>
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title">Form Edit Absensi Mahasiswa {{ $data->mhs->nama }}</div>
        </div>
        <form action="{{ Route('backend.absen.update', $data->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <div class="input-group mb-3">
                                    <input type="hidden" class="form-control" name="mhs_id" value="{{ Auth::user()->mhs->id }}">
                                </div>
                            </div>
                        </div>
