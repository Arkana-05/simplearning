@extends('layouts.app')
@section('title')
    <title>Edit Data Mata Kuliah {{ $data->nama }} | Sistem Informasi E-learning</title>
@endsection
@section('header')
...
<div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <form action="{{ Route('backend.matkul.update', $data->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                    ...
                    <div class="row form-row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control @error('kode') is-invalid @enderror" name="kode" placeholder="Masukkan Kode Matkul" value="{{ old('kode', $data->kode) }}">
                                    @error('kode')
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control @error('sks') is-invalid @enderror" name="sks" placeholder="Masukkan SKS" value="{{ old('sks', $data->sks) }}">
                                    @error('sks')
                                        <div class="invalid invalid-feedback">{{$message}}</div>
                                    @enderror
                                </div>
