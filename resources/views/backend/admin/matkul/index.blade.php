@extends('layouts.app')
@section('title')
    <title>Data Master Mata Kuliah | Sistem Informasi E-learning</title>
@endsection
      ...
      <div class="card">
        <div class="card-header">
          <div class="d-flex align-items-center">
            ...
            <a class="btn btn-primary btn-round ms-auto" href="{{ route('backend.matkul.create') }}">
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-button-action">
                      <a href="{{ Route('backend.matkul.edit', $d->id) }}" type="button" data-bs-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Task"  style="padding: 10px">
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <form action="{{ Route('backend.matkul.destroy', $d->id) }}"
                                  method="post">
                                  @csrf
                                  @method('delete')
