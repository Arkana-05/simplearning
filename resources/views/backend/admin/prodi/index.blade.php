@extends('layouts.app')
@section('title')
    <title>Data Master Prodi | Sistem Informasi E-learning</title>
@endsection

@section('header')
    <div class="page-header">
        <h3 class="fw-bold mb-3">Data Prodi</h3>
      ...
      <div class="card">
        <div class="card-header">
          <div class="d-flex align-items-center">
            ...
            <a class="btn btn-primary btn-round ms-auto" href="{{ route('backend.prodi.create') }}">
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-button-action">
                      <a href="{{ Route('backend.prodi.edit', $d->id) }}" type="button" data-bs-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Task"  style="padding: 10px">
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <form action="{{ Route('backend.prodi.destroy', $d->id) }}"
                                  method="post">
                                  @csrf
                                  @method('delete')
