@extends('layouts.app')
@section('title')
    <title>Tambah Data Materi | Sistem Informasi E-learning</title>
@endsection
@section('header')
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <div class="card-title">Form Tambah Data Materi</div>
        </div>
        <form action="{{ url('backend/materi') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card-body">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control @error('judul') is-invalid @enderror" name="judul" placeholder="Masukkan Judul Materi" value="{{ old('judul') }}">
                                    @error('judul')
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <div class="col-lg-12 mb-3">
                                    <textarea class="form-control @error('desc') is-invalid @enderror" placeholder="Deskripsi / Rangkuman Isi Materi ....." id="texteditor" name="desc">{{ old('desc') }}</textarea>
                                    @error('desc')
