@extends('layouts.app')
@section('title')
    <title>Data Master Prodi Ruang Kelas | Sistem Informasi E-learning</title>
@endsection

@section('header')
    <div class="page-header">
        <h3 class="fw-bold mb-3">Data Ruang</h3>
      ...
      <div class="card">
        <div class="card-header">
          <div class="d-flex align-items-center">
            <h4 class="card-title">Data Ruang Kelas</h4>
            <a class="btn btn-primary btn-round ms-auto" href="{{ route('backend.ruang.create') }}">
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-button-action">
                      <a href="{{ Route('backend.ruang.edit', $d->id) }}" type="button" data-bs-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Edit Task"  style="padding: 10px">
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <form action="{{ Route('backend.ruang.destroy', $d->id) }}"
                                  method="post">
                                  @csrf
                                  @method('delete')
